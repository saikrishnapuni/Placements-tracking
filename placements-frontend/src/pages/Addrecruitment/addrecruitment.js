    ...
    return (
        <div className={classes.thisbody} style={{ marginBottom: "10rem" }}>
            ...
            <div className={classes.mainbody}>
                <form onSubmit={addrecruitment} className={classes.form}>
                    <div className={classes.mainbody}>
                        ...
                        <div className={classes.skill_div}>
                            ...
                            <div className={classes.input_skill_div}>
                                <input className={classes.skillsInput} placeholder="Add skills required" id="skill" onChange={e => setSkill(e.target.value)} />
